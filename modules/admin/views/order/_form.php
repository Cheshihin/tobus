...
//            ]);
    ...
    <div class="row">
        ...
        <div class="col-sm-4 form-group form-group-sm">
            <?= $form->field($model, 'categ_id')->textInput() ?>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-4 form-group form-group-sm">
            <?php
            if($model->time_getting_into_car > 0 && !preg_match('/^[0-9]{2}\.[0-9]{2}\.[0-9]{4} [0-9]{2}:[0-9]{2}$/i', $model->time_getting_into_car)) {
                $model->time_getting_into_car = date("d.m.Y H:i", $model->time_getting_into_car);
            }
            echo $form->field($model, 'time_getting_into_car')->widget(DateTimePicker::classname(), [
                'pluginOptions' => [
                    'format' => 'dd.mm.yyyy hh:i',
                    'autoclose' => true
                ]
